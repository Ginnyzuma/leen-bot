  ...
  async execute(interaction, client) {
            ...
            if (msg.deletable) {
              msg.delete().then(async () => {
                const embed = new client.discord.MessageEmbed()
                  .setColor('ff9600')
                  .setAuthor('Ticket', ' ')
                  .setDescription(`<@!${interaction.user.id}> a créé **Ticket** pour ・ ${i.values[0]}`)
                  .setFooter('Ticket System', ' ')
                  .setTimestamp();
    ...
    if (interaction.customId == "close-ticket") {
      ...
      const verif = await interaction.reply({
        content: 'Etes vous sûr de vouloir fermer le ticket ?',
        components: [row]
      });
      ...
      collector.on('collect', i => {
        if (i.customId == 'confirm-close') {
          interaction.editReply({
            content: `Le ticket est fermé par <@!${interaction.user.id}>`,
            components: []
          });
        ...
        hastebin.createPaste(a, {
          ...
          .then(function (urlToPaste) {
            ...
            const embed2 = new client.discord.MessageEmbed()
              .setAuthor('Logs Ticket', ' ')
              .setDescription(`📰 Logs de votre ticket \`${chan.id}\`: [**Clic ici pour voir le logs de votre ticket*](${urlToPaste})`)
              .setColor('2f3136')
              .setTimestamp();
